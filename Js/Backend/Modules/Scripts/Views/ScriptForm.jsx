...
class EventForm extends Webiny.Ui.View {
    constructor(props) {
        ...
        this.bindMethods('updateExample');
    }

    updateExample(name) {
        if (_.isEmpty(name)) {
            this.state.eventName = 'myEventName';
        } else {
                        ...
                        <Ui.Panel.Body>
                            ...
                            <Ui.Grid.Row>
                                <Ui.Grid.Col all={12}>
                                    ...
                                    <Ui.Input label="Name" name="name" validate="required" onChange={this.updateExample(model.name)}/>
                            ...
                            <Ui.Grid.Row>
                                <Ui.Grid.Col all={12}>
                                    ...
                                    <pre>Webiny.Sam.Event('{this.state.eventName}');</pre>
